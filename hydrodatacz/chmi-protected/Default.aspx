      ...
      <div class="heading1">  <asp:Label CssClass="heading1" ID="PageTitle" runat="server" Text="Web Service"></asp:Label>
       ...
       <div class="intro">
            ...
            to provide access to data from the <a href="http://grafy.plaveniny.cz/en/snow"
                target="_blank"><span style="color: #0000ff">Czech Snow Observation sites</span></a><br />
            at the CHMI and Povodi Ohre for information about past and present snow depth. <strong>
                <br />
            </strong>
