...
namespace v1_1 {
   ...
   * */
       ...
       ResponseElementName = "TimeSeriesResponse")]  
        ...
        [WebMethod(Description = "GetAuthToken: returns the authentication token for the user and password")]
        string GetAuthToken(string userName, string password);

        [WebMethod(Description = "GetAuthTokenObject")]
        XmlDocument GetAuthTokenObject(string userName, string password);
