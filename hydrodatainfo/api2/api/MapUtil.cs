...
namespace api
{
    ...
    //todo fix! this is not supported until we get binary file from map
    public static class MapUtil
    {
        public static List<ValueInfo> GetMapFromDb(string varCode, DateTime startDateTime, DateTime endDateTime, string aggregate)
        {
            ...
            string tableName = "snow"; //todo Fix! need binary file for map

            string columnName = "snow"; //todo Fix! need binary file for map
