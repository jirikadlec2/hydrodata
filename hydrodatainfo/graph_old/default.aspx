...
<input name="siteCode" type="text" value="CZSNW:1" /><br />
<label for="variableCode">variableCode</label>
<input name="variableCode" type="text" value="CZSNW:16" /><br />
<label for="startDate">startDate</label>
<input name="startDate" type="text" value="2012-06-09" /><br />
<label for="endDate">endDate</label>
<input name="endDate" type="text" value="2012-06-14" /><br />
<label for="serviceURL">serviceURL</label>
<input name="serviceURL" type="text" value="http://hydrodata.cz/cz_snow/cuahsi_1_1.asmx" size="100" /><br />
