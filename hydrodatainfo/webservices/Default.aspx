    ...
    <div id="content">
      ...
      <div class="heading1">  <asp:Label CssClass="heading1" ID="PageTitle" runat="server" Text="Web Service"></asp:Label>
       ...
       <div class="intro">
            ...
            to provide access to quality controlled data from the <a href="http://www7.ncdc.noaa.gov/rest"
                target="_blank"><span style="color: #0000ff">Climate stations</span></a><br />
            in Europe with daily precipitation and temperature values.<strong>
                <br />
            </strong>
